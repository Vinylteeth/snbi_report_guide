export const approachBridgeElements = [
...
export const jointsBridgeElements = [
...
export const railingsBridgeElements = [
...
export const deckBridgeElements = [
...
export const wearingBridgeElements = [{ number: 510, name: "Wearing Surfaces", component: "Protective Coating", material: "Other" }];

export const superBridgeElements = [
...
export const paintBridgeElements = [{ number: 515, name: "Steel Protective Coating", component: "Protective Coating", material: "Paint" }];

export const bearingsBridgeElements = [
...
export const subBridgeElements = [
...
export const culvertBridgeElements = [
...
export const elementComponentContainer = document.getElementById("element-components-container");

// Helper function to create a button
export function createButtonElement(cs, elementNumber) {
  const button = document.createElement("button");
  button.className = `component-elements-button${cs}`;
  button.textContent = `CS${cs}`;
  button.dataset.buttonNumber = `Element ${elementNumber}`;
  button.dataset.buttonCategory = `${cs}`;
  button.addEventListener("click", (event) => addDeficiencyButtons(event));
  return button;
}

// Helper function to create an element container
export function createElementContainer(element) {
  const container = document.createElement("div");
  container.className = "component-elements-container";

  // Add CS2, CS3, CS4 buttons
  for (let cs = 2; cs <= 4; cs++) {
    const button = createButtonElement(cs, element.number);
...
// Clear out the container's innerHTML (optional)
elementComponentContainer.innerHTML = "";

// Loop through each component in the bridgeElements array
bridgeElements.forEach((component) => {
  // Add a header for the component
  ...
  // Pre-select the container for this component
  const elementPageContainer = document.getElementById(component.containerID);

  component.elements.forEach((element) => {
    // Create containers for the component
    const elementContainer = createElementContainer(element);
    const elementPage = createElementContainer(element);

    // Append to respective parent containers
...
export function addDeficiencyButtons(event) {
